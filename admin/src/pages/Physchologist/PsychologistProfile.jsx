...
const PsychologistProfile = () => {
  ...
  const { dToken, profileData, setProfileData, getProfileData, backendUrl } = useContext(PsychologistContext)
  ...
  const updateProfile = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(backendUrl + '/api/psychologist/update-profile', updateData, {headers:{dToken}})
      if (data.success) {
    ...
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {/* ----Psy Info : name, degree, experience */}

...
const bookAppointment = async (req, res) => {
    try {
        ...
        const { userId, psyId, slotDate, slotTime } = req.body

        const psyData = await psychologistModel.findById(psyId).select('-password')

        if (!psyData.available) {
            return res.json({ success: false, message: 'Psychologist Not Available' })
        }
        ...
        //save new slots data in psyData
